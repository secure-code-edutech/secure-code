...
1.  SQL Injection
      Lokasi: /search (query disusun dengan string concatenation), /posts/:id, /login (query username).
      Dampak: baca/ubah data, bypass logika aplikasi.
      Contoh: ?q=Insecure' OR '1'='1.

2.  Broken Access Control / IDOR
      Lokasi: /posts/:id (tidak ada autentikasi/otorisasi).
      Dampak: akses konten milik user lain/privat.

3.  Hardcoded secret
      Lokasi: const API_TOKEN = 'super-secret-...' + endpoint /bad-secret.
